...
st.set_page_config(
    page_title="BAZI Tennis V5.2 VERIFIED",
    page_icon="🎾",
    layout="wide",
)
...
# UI
# -----------------------------
st.title("🎾 BAZI Tennis V5.2 VERIFIED")
st.caption("API-Tennis live feed • auditable 2026 source matches • small-sample protection • prematch + live analysis")
